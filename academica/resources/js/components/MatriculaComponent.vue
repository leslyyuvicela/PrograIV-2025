      ...
      <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
          <div class="mb-3 row">
            ...
            <div class="col-sm-6">
              <select required v-model="idAlumno" id="cmbAlumno" class="form-select" @change="actualizarAlumno">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-6">
              <input required v-model="fecha" type="date" id="txtFecha" class="form-control" />
            </div>
          </div>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-6">
              <select required v-model="carrera" id="cmbCarrera" class="form-select">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-6">
              <select required v-model="periodo" id="cmbPeriodo" class="form-select">
        ...
        <div class="card-footer bg-light text-end">
          <div class="d-flex justify-content-end gap-2">
            ...
            <button type="reset" @click="nuevaMatricula" class="btn btn-warning">Nuevo</button>
            <button type="button" @click="buscarMatricula" class="btn btn-info text-white">Buscar</button>
          </div>
        </div>
      </div>
    </form>
